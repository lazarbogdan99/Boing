...
public class ClosedShape {
     ...
     */
    protected ClosedShape (String shape,int insertionTime, int x, int y, int vx, int vy, Color colour, boolean isFilled, boolean pulse) {
        this.shape = shape;
        this.x = x;
        this.y = y;
        this.xVec = vx;
    ...
    /**
     * this method sets the pulsation
    ...
    /**
     * checking if the shape is pulsing
    ...
    /**
     * seting the moving
     * @param status true if is moving, false if not
     */
    ...
    /**
     * chcking if the shape is moving
